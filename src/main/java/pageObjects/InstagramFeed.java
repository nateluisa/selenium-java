...
public class InstagramFeed {
    ...
    public InstagramFeed(ChromeDriver driver) {
        this.driver = driver;
    }
    public void noNotifications() {
        WebElement popupNotNow = driver.findElement(By.cssSelector("body > div.RnEpo.Yx5HN > div > div > div > div.mt3GC > button.aOOlW.HoLwm"));
        popupNotNow.click();
    }
